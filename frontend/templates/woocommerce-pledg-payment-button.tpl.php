<form method="GET" action=<?php echo esc_attr($pledg_url) ?>>
    <h3><?php __('Transaction Details', 'dotpay-payment-gateway') ?></h3>

    <p><?php __('You chose payment by Pledg. Click Continue do proceed', 'pledg-payment-gateway') ?></p>
	
    <p class="form-submit">
        <input type="hidden" value="<?php echo $pledg_id; ?>" name="id">
        ...
        <input class="button" type="submit" value="<?php __('Continue', 'pledg-payment-gateway') ?>" id="submit_pledg_payment_form">
    </p>
</form>